  ...
  function removeTask(e) {
    if (e.target.checked) {
      let filter = active.filter(
        (task) => task !== e.target.parentElement.textContent
      );
  ...
  return (
    <div className="container">
      ...
      <div className="add-container">
        ...
        <button type="button" className="add-btn" onClick={createTask}>
          Add
        </button>
      </div>
      <div className="todo">
      ...
      {status === "all" && (active.length || completed.length) ? (
